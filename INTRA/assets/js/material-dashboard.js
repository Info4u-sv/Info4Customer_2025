...
(function () {
    ...
    if (isWindows && !$('body').hasClass('sidebar-mini')) {
        ...
        //$('.sidebar .sidebar-wrapper, .main-panel').perfectScrollbar(); COMMENTATO PERCHE Faceva casino con lo scoll verticale SIMONE
...
md = {
    ...
    initRightMenu: debounce(function () {
        ...
        if (!mobile_menu_initialized) {
            ...
            // Rimosso INFO4U campo ricerca non viene più utilizzato
