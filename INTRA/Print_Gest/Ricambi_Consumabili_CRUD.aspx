<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ricambi_Consumabili_CRUD.aspx.cs" Inherits="INTRA.Print_Gest.Ricambi_Consumabili_CRUD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Lista Ricambi Consumabili</h4>
                    <dx:ASPxGridView runat="server" ID="Generic_Gridview" ClientInstanceName="Generic_Gridview" AutoGenerateColumns="False" DataSourceID="Ricambi_Dts" OnRowInserting="Generic_gridview_RowInserting" OnRowUpdating="Generic_gridview_RowUpdating" KeyFieldName="ID" Width="100%" Styles-AlternatingRow-Enabled="True" SettingsPopup-EditForm-HorizontalAlign="WindowCenter" SettingsPopup-EditForm-VerticalAlign="WindowCenter" OnHtmlRowPrepared="ASPxGridView1_HtmlRowPrepared">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="CodiceProdotto" VisibleIndex="2" Width="80px" EditFormSettings-CaptionLocation="Top">
                                <PropertiesTextEdit>
                            ...
                            <dx:GridViewDataSpinEditColumn FieldName="CopiePreviste" VisibleIndex="3" Width="80px" EditFormSettings-CaptionLocation="Top">
                                <PropertiesSpinEdit MinValue="1" MaxValue="99999999">
                                    <InvalidStyle BackColor="LightPink"></InvalidStyle>
                                    <ValidationSettings ErrorDisplayMode="None" CausesValidation="True" ValidationGroup="testValidation">
                                        <ErrorFrameStyle BackColor="LightPink"></ErrorFrameStyle>
                                        <RequiredField IsRequired="True"></RequiredField>
                            ...
                            <dx:GridViewDataBinaryImageColumn FieldName="PhotoBytes" Caption="Immagine" VisibleIndex="9" Width="10%" EditFormSettings-CaptionLocation="Top">
                                <EditItemTemplate>
                            ...
                            <dx:GridViewDataBinaryImageColumn FieldName="Expr1" VisibleIndex="6" Caption="Brand immagine" EditFormSettings-Visible="False">
                                <PropertiesBinaryImage EnableServerResize="True">
                                </PropertiesBinaryImage>
                            </dx:GridViewDataBinaryImageColumn>
                            <dx:GridViewDataComboBoxColumn FieldName="TipoProdID" Caption="Tipo Prodotto" VisibleIndex="8" Width="80px" EditFormSettings-CaptionLocation="Top">
                                <PropertiesComboBox DataSourceID="Tipologia_Ricambi_Consumabili_Dts" ValueField="ID" TextField="Nome">
                                </PropertiesComboBox>
                                <EditItemTemplate>
                                    <dx:ASPxComboBox runat="server" ID="TipoProd_CB" ClientInstanceName="TipoProd_CB"
                                        DataSourceID="Tipologia_Ricambi_Consumabili_Dts" ValueField="ID" TextField="Nome"
                                        Value='<%# Bind("TipoProdID") %>' ValueType="System.Int32" Width="100%"
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="ColoreID" Caption="Colore" VisibleIndex="7" Width="80px" EditFormSettings-CaptionLocation="Top">
                                <PropertiesComboBox DataSourceID="Colori_Dts" ValueField="ID" TextField="Descrizione">
                                </PropertiesComboBox>
                                <DataItemTemplate>
                                    <%# GetColorDotAndName((int)Eval("ColoreID")) %>
                                </DataItemTemplate>
                                <EditItemTemplate>
                                    <dx:ASPxComboBox runat="server" ID="Colore_CB" ClientInstanceName="Colore_CB" DataSourceID="Colori_Dts" ValueField="ID" TextField="Descrizione"
                                        Value='<%# Bind("ColoreID") %>' ValueType="System.Int32" Width="100%"
                                        ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>" InvalidStyle-BackColor="LightPink">
                                        <Columns>
                        ...
                        <dx:EditFormLayoutProperties ColCount="2" SettingsItemCaptions-Location="Top">
                            <Items>
                                ...
                                <dx:GridViewColumnLayoutItem ColumnName="CopiePreviste" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
                                <dx:GridViewColumnLayoutItem ColumnName="Descrizione" ColumnSpan="2" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
                                <dx:GridViewColumnLayoutItem ColumnName="DettaglioProd" ColumnSpan="2" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
                                <dx:GridViewColumnLayoutItem ColumnName="BrandId" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
                                <dx:GridViewColumnLayoutItem ColumnName="ColoreID" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
                                <dx:GridViewColumnLayoutItem ColumnName="TipoProdID" RequiredMarkDisplayMode="Hidden" VerticalAlign="Top" />
    ...
    <asp:SqlDataSource runat="server" ID="Ricambi_Dts" ConnectionString='<%$ ConnectionStrings:info4portaleConnectionString %>'
        SelectCommand="SELECT Ricambi_Consumabili.*, Brand.PhotoBytes AS Expr1 FROM Ricambi_Consumabili INNER JOIN Brand ON Ricambi_Consumabili.BrandId = Brand.ID"
        InsertCommand="INSERT INTO Ricambi_Consumabili(CodiceProdotto, Descrizione, DettaglioProd, CopiePreviste, BrandId, PhotoBytes, TipoProdID, ColoreID, CreatedUser) 
                   VALUES (@CodiceProdotto, @Descrizione, @DettaglioProd, @CopiePreviste, @BrandId, @PhotoBytes, @TipoProdID, @ColoreID, @CreatedUser)"
        UpdateCommand="UPDATE Ricambi_Consumabili SET CodiceProdotto = @CodiceProdotto, Descrizione = @Descrizione, DettaglioProd = @DettaglioProd, CopiePreviste = @CopiePreviste, 
                   BrandId = @BrandId, PhotoBytes = @PhotoBytes, TipoProdID = @TipoProdID, ColoreID = @ColoreID, EditUser = @EditUser, UpdatedOn = GETDATE() WHERE (ID = @ID)"
        DeleteCommand="DELETE FROM Ricambi_Consumabili WHERE (ID = @ID)">
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="DettaglioProd"></asp:Parameter>
            <asp:Parameter Name="CopiePreviste"></asp:Parameter>
            <asp:Parameter Name="BrandId"></asp:Parameter>
            <asp:Parameter Name="PhotoBytes"></asp:Parameter>
            <asp:Parameter Name="TipoProdID"></asp:Parameter>
            <asp:Parameter Name="ColoreID"></asp:Parameter>
    ...
    <asp:SqlDataSource runat="server" ID="Colori_Dts" ConnectionString='<%$ ConnectionStrings:info4portaleConnectionString %>' SelectCommand="SELECT Colori_Print.* FROM Colori_Print"></asp:SqlDataSource>
    <asp:SqlDataSource runat="server" ID="Tipologia_Ricambi_Consumabili_Dts" ConnectionString='<%$ ConnectionStrings:info4portaleConnectionString %>' SelectCommand="SELECT Tipologia_Ricambi_Consumabili.* FROM Tipologia_Ricambi_Consumabili"></asp:SqlDataSource>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script>
        function OnGetRowValuesElimina(index) {
            ConfermaOperazioneWithClientFunction("Conferma Cancellazione", "Confermi di voler eliminare il ricambio consumabile selezionato?", "Conferma", "Annulla", Elimina, null, index, null);
        }
