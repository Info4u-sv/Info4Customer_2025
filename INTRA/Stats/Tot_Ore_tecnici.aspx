<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tot_Ore_tecnici.aspx.cs" Inherits="INTRA.Stats.Tot_Ore_tecnici" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Totale Ore Tecnici</h4>
                    <dx:ASPxGridView runat="server" ID="Generic_Gridview" ClientInstanceName="Generic_Gridview" AutoGenerateColumns="False" DataSourceID="DtsDatiTecniciOre" KeyFieldName="CodCli" Width="100%" Styles-AlternatingRow-Enabled="True" SettingsPopup-EditForm-HorizontalAlign="WindowCenter" SettingsPopup-EditForm-VerticalAlign="WindowCenter">
                        ...
                        <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="DataAware" Landscape="true" LeftMargin="30" FileName="Lista_Totale_Ore_Tecnici" />
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Utente" Caption="Tecnico" VisibleIndex="1" GroupIndex="0" SettingsHeaderFilter-Mode="CheckedList">
                                <DataItemTemplate>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Anno" VisibleIndex="4" Caption="Anno" SettingsHeaderFilter-Mode="CheckedList"></dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Mese" VisibleIndex="3" Caption="Mese" SettingsHeaderFilter-Mode="CheckedList"></dx:GridViewDataTextColumn>
                        </Columns>
    ...
    <asp:SqlDataSource ID="DtsDatiTecniciOre" runat="server" ConnectionString="<%$ ConnectionStrings:info4portaleConnectionString %>" SelectCommand="SELECT Utente, CAST(ROUND(TotaleTempo, 2) AS numeric(36 , 2)) AS TotaleTempo, Anno, DATENAME(Month, DATEADD(Month, Mese, 0) - 1) AS Mese FROM Tck_Tot_Ore_tecnici_View GROUP BY Utente, TotaleTempo, Anno, Mese"></asp:SqlDataSource>
