...
namespace INTRA.AppCode
{
    public class TCK_Ticket
    {
        ...
        public string DescrizioneStatus { get; set; }

        public DateTime DataInizioIntervento { get; set; }

        public bool TicketStorico { get; set; }

        public string DataChiusuraTCK { get; set; }

        public string TecnicoChiusuraTCK { get; set; }
        ...
        public void ChiusuraForzataRapportino_Update(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public void TCK_TicketTestata_Update(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public void TCK_TestataTicket_FirmaUpdate(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[4];
        ...
        public void TCK_TestataTicket_TecnicoFirmaUpdate(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void TCK_LinkTckPdf_Set(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];
        ...
        public void RiaperturaForzataRapportino_Update(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void StatusControlloFatture_Update(TCK_Ticket Fatture)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[5];
            ...
            //objParams[3] = new SqlParameter("@DaFatturare", Fatture.DaFatturare);
        ...
        public void InvioMailCliente_Insert(TCK_Ticket MailCliente)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void TCK_UpdateCliente_Rapportino(TCK_Ticket Rapportini)
        {
        ...
        public void StatusControlloRegistrazione_Update(TCK_Ticket Registrazione)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void UpdateCliente_Rapportini(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public TCK_Ticket TCK_TestataTicket_Cliente_Get(string codCli)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            ...
            TCK_Ticket TCK_TestataTicket_Cliente_Get_Istanza = new TCK_Ticket();
        ...
        public void TCK_PartiSost_King_Update(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void TCK_TestataTicket_AvviaTicket_Dashboard(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];
        ...
        public void TCK_TicketTestata_UpdateCalendar(TCK_Ticket Rapportini)
        {
            string firmavuota = "data:image/png;base64,";
        ...
        public void TCK_DettTecniciTicket_DeleteCalendar(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[1];
        ...
        public List<TCK_Ticket> IdExchangeByTicket(int CodRapportino)
        {
            ...
            List<TCK_Ticket> Lista = new List<TCK_Ticket>();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        TCK_Ticket Elemento = new TCK_Ticket();
        ...
        public List<TCK_Ticket> ListaTecniciTicket(int CodRapportino)
        {
        ...
        public List<TCK_Ticket> TecnicoResourceId_Get(string ResourceID)
        {
        ...
        public TCK_Ticket DatiTestataTicket_Get(int CodRapportino)
        {
            string queryString = "SELECT TCK_TestataTicket.* ,TCK_StatusChiamata.Descrizione as DescrizioneStatus FROM TCK_TestataTicket INNER JOIN TCK_StatusChiamata ON TCK_TestataTicket.TCK_StatusChiamata = TCK_StatusChiamata.ValueField where TCK_TestataTicket.[CodRapportino] = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        ...
                        Elemento.RecurrenceInfo = reader["RecurrenceInfo"].ToString();
                        Elemento.DataIntervento = reader["DataIntervento"].ToString();
                        Elemento.RecurrenceEvent = Convert.ToInt32(reader["RecurrenceEvent"]);
                        Elemento.ResourceId = reader["ResourceId"].ToString();
                        Elemento.CodiceImpianto = reader["CodiceImpianto"].ToString();
                        Elemento.DescrizioneStatus = reader["DescrizioneStatus"].ToString();
                    }
                }
                catch { }
            }
        ...
        public void TCK_TestataTicket_ResourceIdUpdate(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];
        ...
        public void TCK_TestataTicket_UpdateDynamic(TCK_Ticket Parametri, string NomeColonna)
        {
        ...
        public void TCK_Task_Dettaglio_UpdateDynamic(TCK_Ticket Parametri, string NomeColonna, string NomeTabella)
        {
            // Devo fare un update nella tabella TCK_DettTecniciTicket
        ...
        public void UpdateDynamic(TCK_Ticket Parametri, string NomeColonna, string NomeTabella, string ParametroWhere)
        {
            // Devo fare un update nella tabella TCK_DettTecniciTicket
            string Command_Txt = " UPDATE [" + NomeTabella + "] set " + NomeColonna + " = " + Parametri.ValoreColonna + " where " + ParametroWhere + " = " + Parametri.Id;
            using (SqlConnection connection =
                   new SqlConnection(ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ConnectionString))
            {
                SqlCommand command = new SqlCommand(Command_Txt, connection);
        ...
        {
            string queryString = "SELECT ID  as Aperti  FROM  [TCK_Task_Dettaglio] where IdTck = {0} and Richiesto = 1 and chiuso = 0";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
        ...
        public int NumerotecniciperTaskTicket(int CodRapportino)
        {
            string queryString = "SELECT Count(ID)  as TotaleTecnici  FROM  [TCK_DettTecniciTicket_Finale] where CodRapportino = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        TotaleTecnici = Convert.ToInt32(reader["TotaleTecnici"]);
                    }
                }
                catch { }
            }
            return TotaleTecnici;
        }



        public void TCK_TestataTicket_Impianto_Update(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[4];

            objParams[0] = new SqlParameter("@CodCli", Rapportini.CodCli);
            objParams[1] = new SqlParameter("@Società", Rapportini.Società);
            objParams[2] = new SqlParameter("@CodRapportino", Rapportini.CodRapportino);
            objParams[3] = new SqlParameter("@CodiceImpianto", Rapportini.CodiceImpianto);

            //COL_DetRapportini_Edit
            objSqlHelper.ExecuteNonQueryForNews("TCK_TestataTicket_Impianto_Update", objParams);
        }


        public void TCK_Ticket_Task_Delete(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[1];
            ...
            objSqlHelper.ExecuteNonQueryForNews("TCK_Ticket_Task_Delete", objParams);
        }

        public string ImpiantoTCK_Get(int CodRapportino)
        {
            string SqlString = "SELECT LFT_Impianti.Ubicazione, LFT_Impianti.ViaPiazza, LFT_Impianti.Localita, LFT_Impianti.Indirizzo, LFT_Impianti.NumCivico, LFT_Impianti.Provincia, LFT_Impianti.Cap FROM TCK_TestataTicket INNER JOIN  LFT_Impianti ON TCK_TestataTicket.CodiceImpianto = LFT_Impianti.SERIAL_Gestionale where CodRapportino = " + CodRapportino;
            using (SqlConnection myConnection = new SqlConnection())
            {
                myConnection.ConnectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ConnectionString;
                SqlCommand myCommand = new SqlCommand();
                ...
                else
                {
                    while (myReader.Read())
                    {
                       Indirizzo  = myReader["ViaPiazza"].ToString() + " " + myReader["Indirizzo"].ToString() + ", " + myReader["NumCivico"].ToString() + ", " + myReader["Cap"].ToString() + " " + myReader["Localita"].ToString() + " (" + myReader["Provincia"].ToString() + ")";
                    }
                }
                myReader.Close();
                myConnection.Close();
        ...
        public void TCK_PeriodicheComplete_Delete(TCK_Ticket Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];

            objParams[0] = new SqlParameter("@IDTck", Rapportini.CodRapportino);
            objParams[1] = new SqlParameter("@IDImpianto", Rapportini.IDImpianto);
           
            objSqlHelper.ExecuteNonQueryForNews("TCK_PeriodicheComplete_Delete", objParams);
        }



        public int CheckEsistenzaArticoli(string CodArt)
        {
            string queryString = "SELECT  cOUNT( [CodRicambio]) AS COUNTRICAMBI  FROM [LFT_Ricambi] where  [CodRicambio] =  '{0}'";
            queryString = string.Format(queryString, CodArt);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        TotaleRicambi = Convert.ToInt32(reader["COUNTRICAMBI"]);
                    }
                }
                catch { }
            }
            return TotaleRicambi;
        }

        public int CountTicketStatus(int Status)
        {
            string queryString = "SELECT  cOUNT( [codrapportino]) AS countrapportini  FROM [tck_Testataticket] where  [PresaInCarico] =  {0}";
            queryString = string.Format(queryString, Status);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();

            int TotaleRapportini = 0;
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        TotaleRapportini = Convert.ToInt32(reader["countrapportini"]);
                    }
                }
                catch { }
            }
            return TotaleRapportini;
        }
