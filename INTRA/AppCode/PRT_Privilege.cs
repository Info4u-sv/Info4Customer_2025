...
namespace INTRA.AppCode
{
    public class PRT_Privilege
    {
        ...
        public void PRT_Privilege_Rule_SET(PRT_Privilege _obj)
        {
            ...
            objSqlHelper.ExecuteNonQueryForNews("PRT_Privilege_RulesSetPrivileges", objParams);
        ...
        public void tbl_um_privilege_By_UserVsRoles_SET(string @UserName)
        {
            ...
            objSqlHelper.ExecuteNonQueryForNews("tbl_um_privilege_SET_By_UserVsRoles", objParams);
        ...
        public void sp_um_DeleteUserPrivileges(string @UserName)
        {
            ...
            objSqlHelper.ExecuteNonQueryForNews("sp_um_DeleteUserPrivileges", objParams);
        }
        ...
        public void PRT_Privileges_DELETE_ByFormId(int form_id_fk)
        {
            ...
            objSqlHelper.ExecuteNonQueryForNews("PRT_Privileges_DELETE_ByFormId", objParams);
        }
    }
}