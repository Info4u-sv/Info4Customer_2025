...
{
    public partial class _16PlusDisplayBannerImgRandom : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ImageBanner = Request.ApplicationPath.TrimEnd('/') + "/images/banner-catalogo/" + img + string.Empty;
            }
