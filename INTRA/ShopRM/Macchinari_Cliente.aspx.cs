...
{
    public partial class Macchinari_Cliente : System.Web.UI.Page
    {
        ...
        public static string GetBase64Image(object imageObj)
        {
            if (imageObj == DBNull.Value || imageObj == null) return "";
