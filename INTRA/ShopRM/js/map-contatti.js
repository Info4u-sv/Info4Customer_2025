$(function() {
	...
	function initialize() {
        ...
        var lat = $('#map-canvas-contatti').attr("data-lat");
        var lng = $('#map-canvas-contatti').attr("data-lng");

        var myLatlng = new google.maps.LatLng(lat, lng);

        var setZoom = parseInt($('#map-canvas-contatti').attr("data-zoom"));
        ...
        map = new google.maps.Map(document.getElementById("map-canvas-contatti"), mapOptions);
