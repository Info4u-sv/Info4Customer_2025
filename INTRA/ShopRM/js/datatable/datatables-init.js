...
var InitiateSearchableClientiDataTable = function () {
    return {
        init: function () {
            var oTable = $('#searchable').dataTable({
...
var InitiateSearchableDataTableID = function () {
    return {
        init: function () {
            var oTable = $('#searchable').dataTable({
...
var InitiateSearchable_T2IDDataTable = function () {
    return {
        init: function () {
            var oTable = $('#searchable_T2').dataTable({
...
var InitiateSearchableDataHTML5_T2NOIDTable = function () {
    return {
        init: function () {
            var oTable = $('#searchableHTML5_T2').dataTable({
                "sDom": "Bflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
...
var InitiateSearchableDataHTML5_T1Table = function () {
    return {
        init: function () {
            var oTable = $('#searchableHTML5').dataTable({
                //"dom": '<"top"i>rt<"bottom"flp><"clear">',
