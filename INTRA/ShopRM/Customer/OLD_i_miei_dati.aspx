<%@ Page Title="" Language="C#" MasterPageFile="~/ShopRM/Catalogo.Master" AutoEventWireup="true" CodeBehind="OLD_i_miei_dati.aspx.cs" Inherits="INTRA.ShopRM.Customer.OLD_i_miei_dati" %>
                                                ...
                                                <div class="dxflGroupBox_Office365 fullWidth fullHeight dxflGroupBoxSys">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12" style="padding: 20px">
                                                        ...
                                                        <div style="padding-top: 40px">
                                                            <dx:ASPxButton runat="server" ID="ASPxButton1" ValidationGroup="Email" Text="Conferma Variazione" ClientInstanceName="SalvaEmail_Btn" Width="100%" CssClass="btn" AutoPostBack="false">
