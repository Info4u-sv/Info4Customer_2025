<%@ Page Title="" Language="C#" MasterPageFile="~/ShopRM/Catalogo.Master" AutoEventWireup="true" CodeBehind="EditClienteTec.aspx.cs" Inherits="INTRA.ShopRM.TecZone.EditClienteTec" %>
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-sm-12 information-entry">
            <div class="heading-article">
                <h2 class="title">Edit Cliente</h2>
            </div>
            <div class="article-container">
                <p>Tramite questa pagina puoi modificare i dati del cliente -- <dx:ASPxLabel runat="server" ID="CodCli_lbl"></dx:ASPxLabel> </p>
                    ...
                    <PanelCollection>
                        <dx:PanelContent>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-margin no-padding editcontainer">
                                <dx:ASPxFormLayout runat="server" ID="InserimentoArticolo_FormLy" ClientInstanceName="InserimentoArticolo_FormLy" Width="100%" Paddings-Padding="0" BackColor="White" ValidateRequestMode="Disabled" DataSourceID="Cliente_dts">
                                                    ...
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            ...
                                                            <div class="col-md-12 no-padding" style="padding-top: 15px;">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <dx:ASPxTextBox ID="Cognome_text" ClientInstanceName="Cognome_text" Caption="Cognome" CaptionCellStyle-CssClass="dx-caption" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Cognome") %>'>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <dx:ASPxTextBox ID="Nome_text" ClientInstanceName="Nome_text" Caption="Nome" CaptionCellStyle-CssClass="dx-caption" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Nome") %>'>
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px"></CaptionCellStyle>
                                                                        <CaptionSettings Position="Top" />
                                                                        <ValidationSettings CausesValidation="true" ErrorDisplayMode="none" ValidationGroup="NuovoProspectValidator" ValidateOnLeave="false">
                                                                            <RequiredField IsRequired="True"></RequiredField>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <dx:ASPxTextBox ID="Indirizzo_Txt" ClientInstanceName="Indirizzo_Txt" Caption="Indirizzo:" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Ind") %>'>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <dx:ASPxTextBox ID="Local_Txt" ClientInstanceName="Local_Txt" Caption="Località" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Loc") %>'>
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px" CssClass="dx-caption"></CaptionCellStyle>
                                                                        <CaptionSettings Position="Top" />
                                                                        <ValidationSettings CausesValidation="true" ErrorDisplayMode="none" ValidationGroup="NuovoProspectValidator">
                                                                            <RequiredField IsRequired="True"></RequiredField>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <dx:ASPxComboBox ID="Provincia_Combobox" ClientInstanceName="Provincia_Combobox" Caption="Provincia:" runat="server" Width="100%" Value='<%#DataBinder.Eval(Container.DataItem,"Prov") %>'>
                                                                        <CaptionSettings Position="Top" />
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px" CssClass="dx-caption"></CaptionCellStyle>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <dx:ASPxTextBox ID="Cap_text" ClientInstanceName="Cap_text" Caption="Cap:" CssClasses-Caption="TitleCell" Width="100%" runat="server" MaxLength="5" Text='<%#DataBinder.Eval(Container.DataItem,"Cap") %>'>
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px" CssClass="dx-caption"></CaptionCellStyle>
                                                                        <CaptionSettings Position="Top" />
                                                                        <ValidationSettings CausesValidation="true" ErrorDisplayMode="none" ValidationGroup="NuovoProspectValidator">
                                                                            <RequiredField IsRequired="True"></RequiredField>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <dx:ASPxCallback runat="server" ID="EmailCheck_callback" ClientInstanceName="EmailCheck_callback" OnCallback="EmailCheck_callback_Callback" Width="100%">
                                                                        <ClientSideEvents CallbackComplete="CompleteCheckCallback" />
                                                                    </dx:ASPxCallback>
                                                                    <dx:ASPxTextBox ID="EMail_text" ClientInstanceName="EMail_text" Caption="EMail:" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Email") %>'>
                                                                        <CaptionSettings Position="Top" />
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px" CssClass="dx-caption"></CaptionCellStyle>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <dx:ASPxTextBox ID="Tel_text" ClientInstanceName="Tel_text" Caption="Tel:" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Tel") %>'>
                                                                        <CaptionSettings Position="Top" />
                                                                        <CaptionCellStyle Paddings-PaddingBottom="10px" CssClass="dx-caption"></CaptionCellStyle>
                                                                        <ValidationSettings CausesValidation="true" ErrorDisplayMode="none" ValidationGroup="NuovoProspectValidator">
                                                                            <RequiredField IsRequired="True"></RequiredField>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <dx:ASPxTextBox ID="CF_Txt" ClientInstanceName="CF_Txt" Caption="Codice fiscale:" Width="100%" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CF")%>'>
                                                                        <CaptionSettings Position="Top" />
                                                            ...
                                                            <div class="col-md-3" style="display: none;">
                                                                ...
                                                                <asp:SqlDataSource runat="server" ID="CanaliAcquisizione_Sql" ConnectionString='<%$ ConnectionStrings:GestionaleConnectionString %>' SelectCommand=""></asp:SqlDataSource>
                                                            </div>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                    <Paddings Padding="0px"></Paddings>
                                ...
                                <asp:SqlDataSource runat="server" ID="Cliente_dts" ConnectionString='<%$ ConnectionStrings:info4portaleConnectionString %>' SelectCommand="SELECT Nome, Cognome, Ind, Prov, Loc, Tel, CF, EMail,Cap FROM Clienti WHERE (CodCli = @CodCli)">
                                    <SelectParameters>
                                ...
                                <div class="col-md-12">
                                    <dx:BootstrapButton ID="Salva_Btn" ClientInstanceName="Salva_Btn" runat="server" AutoPostBack="false" ValidationGroup="NuovoProspectValidator"
                                        ...
                                        <ClientSideEvents
                                            Click="function(s,e){
                                                EmailCheck_callback.PerformCallback();
                                            } " />
                                    </dx:BootstrapButton>
                                    ...
                                    <dx:ASPxCallback ID="Salvataggio_Callback" ClientInstanceName="Salvataggio_Callback" runat="server" OnCallback="Salvataggio_Callback_Callback">
                                        <ClientSideEvents CallbackComplete="function(s,e){
                                                showNotificationtoastrWithText('Il cliente è stato modificato correttamente');
                                            }" />
                                    </dx:ASPxCallback>
