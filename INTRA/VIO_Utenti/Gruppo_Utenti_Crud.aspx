<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gruppo_Utenti_Crud.aspx.cs" Inherits="INTRA.VIO.Utenti.Gruppo_Utenti_Crud" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-lg-10 col-md-9 col-sm-9">
        <div class="card">
            ...
            <div class="card-content">
                <h4 class="card-title">Lista Clienti</h4>
        <script>
            var comando;
