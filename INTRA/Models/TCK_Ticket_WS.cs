...
{
    public class TCK_Ticket_WS
    {
        public TCK_Ticket_WS()
        {
            //
        ...
        #region property
        public int CodRapportino { get; set; }
        ...
        public string Tecnici { get; set; }

        public bool AssegnatoCalendTecnico { get; set; }

        public string InizioIntervento { get; set; }
        public string FineIntervento { get; set; }
        ...
        public int RecurrenceEvent { get; set; }

        public bool TicketPadre { get; set; }

        public string IDRecurrence { get; set; }

        public string Impianto { get; set; }

        public string CodiceImpianto { get; set; }

        public string DataFineIntervento { get; set; }

        public bool PrioritaCalendario { get; set; }

        public string ValoreColonna { get; set; }
        ...
        public int InsertCOL_Rapportini(TCK_Ticket_WS Rapportini)
        {
            ...
            objParams[16] = new SqlParameter("@TCK_PrioritaRichiesta", Rapportini.TCK_PrioritaRichiesta);

            objParams[17] = new SqlParameter("@MotivoChiamata", Rapportini.MotivoChiamata);
            objParams[18] = new SqlParameter("@NomePersonaRiferimento", Rapportini.NomePersonaRiferimento);
            objParams[19] = new SqlParameter("@TelPersonaRiferimento", Rapportini.TelPersonaRiferimento);
            objParams[20] = new SqlParameter("@MailPersonaRiferimento", Rapportini.MailPersonaRiferimento);
            objParams[21] = new SqlParameter("@InterventoPresso", Rapportini.InterventoPresso);

            objParams[22] = new SqlParameter("@InsertUser", Rapportini.EditUser);
            ...
            objParams[26] = new SqlParameter("@Customer", Rapportini.Customer);

            int LastId = objSqlHelper.ExecuteNonQueryForNews("TCK_TicketTestata_Insert", objParams);
            return LastId;
        }

        public void UpdateCOL_Rapportini(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public void ChiusuraForzataRapportino_Update(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public void TCK_TicketTestata_Update(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public void TCK_TestataTicket_FirmaUpdate(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[4];
        ...
        public void TCK_TestataTicket_TecnicoFirmaUpdate(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void TCK_LinkTckPdf_Set(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];
        ...
        public void RiaperturaForzataRapportino_Update(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void StatusControlloFatture_Update(TCK_Ticket_WS Fatture)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[5];
        ...
        public void InvioMailCliente_Insert(TCK_Ticket_WS MailCliente)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void TCK_UpdateCliente_Rapportino(TCK_Ticket_WS Rapportini)
        {
        ...
        public void StatusControlloRegistrazione_Update(TCK_Ticket_WS Registrazione)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public void UpdateCliente_Rapportini(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
        ...
        public TCK_Ticket_WS TCK_TestataTicket_Cliente_Get(string codCli)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            ...
            TCK_Ticket_WS TCK_TestataTicket_Cliente_Get_Istanza = new TCK_Ticket_WS();
            using (SqlDataReader reader = objSqlHelper.ExecuteReader("TCK_TestataTicket_Cliente_Get", objParams))
            {
                while (reader.Read())
                {
                    ...
                    if (reader.IsDBNull(reader.GetOrdinal("Tel"))) { TCK_TestataTicket_Cliente_Get_Istanza.Tel = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Tel = reader.GetString(reader.GetOrdinal("Tel")); }
                    if (reader.IsDBNull(reader.GetOrdinal("Fax"))) { TCK_TestataTicket_Cliente_Get_Istanza.Fax = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Fax = reader.GetString(reader.GetOrdinal("Fax")); }
                    if (reader.IsDBNull(reader.GetOrdinal("Riferim"))) { TCK_TestataTicket_Cliente_Get_Istanza.Riferim = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Riferim = reader.GetString(reader.GetOrdinal("Riferim")); }

                    if (reader.IsDBNull(reader.GetOrdinal("PIva"))) { TCK_TestataTicket_Cliente_Get_Istanza.PIva = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.PIva = reader.GetString(reader.GetOrdinal("PIva")); }
                    if (reader.IsDBNull(reader.GetOrdinal("EMail"))) { TCK_TestataTicket_Cliente_Get_Istanza.EMail = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.EMail = reader.GetString(reader.GetOrdinal("EMail")); }
                    if (reader.IsDBNull(reader.GetOrdinal("Loc"))) { TCK_TestataTicket_Cliente_Get_Istanza.Loc = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Loc = reader.GetString(reader.GetOrdinal("Loc")); }

                    if (reader.IsDBNull(reader.GetOrdinal("Prov"))) { TCK_TestataTicket_Cliente_Get_Istanza.Prov = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Prov = reader.GetString(reader.GetOrdinal("Prov")); }
                    if (reader.IsDBNull(reader.GetOrdinal("Cap"))) { TCK_TestataTicket_Cliente_Get_Istanza.Cap = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Cap = reader.GetString(reader.GetOrdinal("Cap")); }
                    if (reader.IsDBNull(reader.GetOrdinal("Ind"))) { TCK_TestataTicket_Cliente_Get_Istanza.Ind = string.Empty; } else { TCK_TestataTicket_Cliente_Get_Istanza.Ind = reader.GetString(reader.GetOrdinal("Ind")); }
        ...
        public void TCK_PartiSost_King_Update(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];
        ...
        public string Priorita_Get(int Priorità)
        {

            string SqlString = "SELECT [Descrizione] FROM  [TCK_PrioritaRichiesta] where Id =" + Priorità;

            string DescrPriorità = string.Empty;
...
#pragma warning restore CS0219 // La variabile 'retVal' è assegnata, ma il suo valore non viene mai usato
                ...
                else
                {
                    while (myReader.Read())
                    {
                        DescrPriorità = myReader["Descrizione"].ToString();
                    }
                }
                myReader.Close();
                myConnection.Close();
            }
            return DescrPriorità;
        }

        public string Status_Get(int IDStatus)
        {

            string SqlString = "SELECT  [Descrizione] from [TCK_StatusChiamata] where Id = " + IDStatus;

            string DescrStatus = string.Empty;
...
#pragma warning restore CS0219 // La variabile 'retVal' è assegnata, ma il suo valore non viene mai usato
                ...
                else
                {
                    while (myReader.Read())
                    {
                        DescrStatus = myReader["Descrizione"].ToString();
                    }
                }
                myReader.Close();
                myConnection.Close();
        ...
        public void TCK_TestataTicket_AvviaTicket_Dashboard(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];

            objParams[0] = new SqlParameter("@CodRapportino", Rapportini.CodRapportino);
            objParams[1] = new SqlParameter("@User", Rapportini.User);
            objSqlHelper.ExecuteNonQueryForNews("TCK_TestataTicket_AvviaTicket_Dashboard", objParams);
        }

        public void TCK_TicketTestata_UpdateCalendar(TCK_Ticket_WS Rapportini)
        {
            string firmavuota = "data:image/png;base64,";

            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[30];
            ...
            objParams[29] = new SqlParameter("@CodRapportino", Rapportini.CodRapportino);
            objSqlHelper.ExecuteNonQueryForNews("TCK_TicketTestata_UpdateCalendar", objParams);
        }

        public void TCK_DettTecniciTicket_DeleteCalendar(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[1];

            objParams[0] = new SqlParameter("@CodRapportino", Rapportini.CodRapportino);
            objSqlHelper.ExecuteNonQueryForNews("TCK_DettTecniciTicket_DeleteCalendar", objParams);
        }

        public List<TCK_Ticket_WS> IdExchangeByTicket(int CodRapportino)
        {
            string queryString = "SELECT IDExchange FROM [TCK_DettTecniciTicket] where [CodRapportino] = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();

            List<TCK_Ticket_WS> Lista = new List<TCK_Ticket_WS>();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        TCK_Ticket_WS Elemento = new TCK_Ticket_WS();
                        Elemento.IDExchange = reader["IDExchange"].ToString();
                        Lista.Add(Elemento);
                    }
                }
                catch { }
        ...
        public List<TCK_Ticket_WS> ListaTecniciTicket(int CodRapportino)
        {
            string queryString = "SELECT Utente FROM [TCK_DettTecniciTicket] where [CodRapportino] = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        TCK_Ticket_WS Elemento = new TCK_Ticket_WS();
                        Elemento.Tecnico = reader["Utente"].ToString();
                        Lista.Add(Elemento);
                    }
                }
                catch { }
        ...
        public List<TCK_Ticket_WS> TecnicoResourceId_Get(string ResourceID)
        {
            XmlDocument xmldoc = new XmlDocument();
            xmldoc.LoadXml(@ResourceID);
            XmlNodeList nodeList = xmldoc.GetElementsByTagName("ResourceId");
            ...
            foreach (XmlNode node in nodeList)
            {
                ...
                if (i == 0)
                {
                    Where = "ID = " + node.Attributes["Value"].Value;
                }
                else
                {
                    Where += " or ID = " + node.Attributes["Value"].Value;
                }

                i++;
            }

            string queryString = "SELECT UserNameProfileIntra FROM [PRT_DipendentiAna] where  {0}";
            queryString = string.Format(queryString, Where);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        TCK_Ticket_WS Elemento = new TCK_Ticket_WS();
                        Elemento.Tecnico = reader["UserNameProfileIntra"].ToString();
                        Lista.Add(Elemento);
                    }
                }
                catch { }
        ...
        public TCK_Ticket_WS DatiTestataTicket_Get(int CodRapportino)
        {
            string queryString = "SELECT * FROM [TCK_TestataTicket] where [CodRapportino] = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        Elemento.CodCli = reader["CodCli"].ToString();
                        Elemento.Società = reader["Società"].ToString();
                        Elemento.PIva = reader["PIva"].ToString();
                        Elemento.Indirizzo = reader["Indirizzo"].ToString();
                        Elemento.Cap = reader["Cap"].ToString();
                        Elemento.Località = reader["Località"].ToString();
                        Elemento.Provincia = reader["Provincia"].ToString();
                        Elemento.Telefono = reader["Telefono"].ToString();
                        Elemento.Fax = reader["Fax"].ToString();
                        Elemento.Email = reader["Email"].ToString();
                        Elemento.PersonaDaContattare = reader["PersonaDaContattare"].ToString();
                        Elemento.TCK_TipoRichiesta = Convert.ToInt32(reader["TCK_TipoRichiesta"]);
                        Elemento.TCK_AreaCompetenza = Convert.ToInt32(reader["TCK_AreaCompetenza"]);
                        Elemento.TCK_TipoEsecuzionePresunta = Convert.ToInt32(reader["TCK_TipoEsecuzionePresunta"]);
                        Elemento.TCK_TipoEsecuzione = Convert.ToInt32(reader["TCK_TipoEsecuzione"]);
                        Elemento.TCK_StatusChiamata = Convert.ToInt32(reader["TCK_StatusChiamata"]);
                        Elemento.TCK_PrioritaRichiesta = Convert.ToInt32(reader["TCK_PrioritaRichiesta"]);
                        Elemento.MotivoChiamata = reader["MotivoChiamata"].ToString();
                        Elemento.NomePersonaRiferimento = reader["NomePersonaRiferimento"].ToString();
                        Elemento.TelPersonaRiferimento = reader["TelPersonaRiferimento"].ToString();
                        Elemento.MailPersonaRiferimento = reader["MailPersonaRiferimento"].ToString();
                        Elemento.InterventoPresso = reader["InterventoPresso"].ToString();
                        Elemento.EditUser = reader["InsertUser"].ToString();
                        Elemento.NoteTecnico = reader["NoteTecnico"].ToString();
                        Elemento.OggettoTCK = reader["OggettoTCK"].ToString();
                        Elemento.CodRapportino = Convert.ToInt32(reader["CodRapportino"].ToString());
        ...
        public void TCK_TestataTicket_ResourceIdUpdate(TCK_Ticket_WS Rapportini)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[2];

            objParams[0] = new SqlParameter("@CodRapportino", Rapportini.CodRapportino);
            objParams[1] = new SqlParameter("@ResourceId", Rapportini.ResourceId);
            objSqlHelper.ExecuteNonQueryForNews("TCK_TestataTicket_ResourceIdUpdate", objParams);
        }


        public void TCK_TestataTicket_UpdateDynamic(TCK_Ticket_WS Parametri, string NomeColonna)
        {
            // Devo fare un update nella tabella TCK_DettTecniciTicket
            string Command_Txt = " UPDATE [TCK_TestataTicket] set " + NomeColonna + " = " + Parametri.ValoreColonna + " where CodRapportino = " + Parametri.CodRapportino;
        ...
        public void TCK_Task_Dettaglio_UpdateDynamic(TCK_Ticket_WS Parametri, string NomeColonna, string NomeTabella)
        {
            // Devo fare un update nella tabella TCK_DettTecniciTicket
            string Command_Txt = " UPDATE [" + NomeTabella + "] set " + NomeColonna + " = " + Parametri.ValoreColonna + " where ID = " + Parametri.Id;
            using (SqlConnection connection =
                   new SqlConnection(ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ConnectionString))
            {
                SqlCommand command = new SqlCommand(Command_Txt, connection);
        ...
        // acceptJob  aggiornamento testasta TCK_StatusAccettazione_Update Simone 20/05/2020
        public void TCK_StatusAccettazione_Update(string CodTec, int codRapp, int PresaInCarico)
        {
            Sql4Helper objSqlHelper = new Sql4Helper();
            SqlParameter[] objParams = new SqlParameter[3];

            objParams[0] = new SqlParameter("@CodTec", CodTec);
            objParams[1] = new SqlParameter("@CodRapportino", codRapp);
            objParams[2] = new SqlParameter("@PresaInCarico", PresaInCarico);

            //COL_Rapportini_NoteTecnico_Edit
            objSqlHelper.ExecuteNonQueryForNews("TCK_StatusAccettazione_Update", objParams);

        }

        public TCK_Ticket_WS EtichetteTicket_Get(int CodRapportino)
        {
            string queryString = "SELECT * FROM [ListaTicket_View] where [CodRapportino] = {0}";
            queryString = string.Format(queryString, CodRapportino);
            string connectionString = ConfigurationManager.ConnectionStrings["info4portaleConnectionString"].ToString();
                       ...
                       connectionString))
            {
                ...
                try
                {
                    while (reader.Read())
                    {
                        Elemento.TCK_PrioritaRichiesta_etichetta = reader["PrioritaDescr"].ToString();
                        Elemento.TCK_TipoRichiesta_etichetta = reader["TipoChiamata"].ToString();
                        Elemento.TCK_AreaCompetenza_etichetta = reader["AreaAss"].ToString();
                        Elemento.TCK_TipoEsecuzione_etichetta = reader["TipoEsecDescr"].ToString();
                    }
                }
                catch (Exception ex)
                {
