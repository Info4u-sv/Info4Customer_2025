...
public static class EmailUtility
{
    ...
    //        //string pathLogo = System.Web.HttpContext.Current.Server.MapPath("~/assets/img_customer/title.jpg"); // my logo is placed in images folder
    //        //try
    //        //{
    ...
    //        //string pathUnderlogo = System.Web.HttpContext.Current.Server.MapPath("~/assets/img_customer/thin-horizontal-shadow.jpg"); // my logo is placed in images folder
...
#pragma warning disable CS0168 // La variabile 'e' è dichiarata, ma non viene mai usata
        try
        {
            ...
            //produzione
            string mailAccount = "web-help@info4usrl.it";
            string Smtp_Password = "1Nfo4you_1nf";
            string Smtpsrv = "out.postassl.it";
            int portssl = 465;
            ...
            smtp.Credentials = new System.Net.NetworkCredential(mailAccount, Smtp_Password);
