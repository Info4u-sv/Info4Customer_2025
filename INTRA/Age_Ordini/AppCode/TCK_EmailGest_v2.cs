...
/// <summary>
/// Descrizione di riepilogo per TCK_EmailGest_v2
/// </summary>
namespace INTRA.Age_Ordini.AppCode
{

    public class TCK_EmailGest_v2
    {
        public string MailBody { get; set; }
        public string MailSubject { get; set; }
        public TCK_EmailGest_v2()
        {
            //
        ...
        public static void SendTicketMail(int TicketId, int TicketStatus, string UserCrud, TCK_Ticket_v2 rapportini, string MailTecnico, string NomeTecnico)
        {
            ...
            try
            {
                TCK_EmailGest_v2 GetMailTemplate = new TCK_EmailGest_v2();
                //if (TicketStatus == 8)
                //{
        ...
        public TCK_EmailGest_v2 MailTemplateCreate(int TicketId, int TicketStatus, string UserCrud, TCK_Ticket_v2 rapportini, string MailTecnico, string NomeTecnico)
        {
            TCK_EmailGest_v2 _RetObj = new TCK_EmailGest_v2();
            ...
            MyOrderItems = MyOrder.U_ArticoliOrdini_Get(rapportini.CodRapportino);
            //Testata Richiesta
            BodyM += string.Format(DivT, 25, "", "blue", "<b>Ordine Numero: </b>" + rapportini.CodRapportino);
            ...
            if (!string.IsNullOrEmpty(rapportini.TckInviatoA))
            {
                ...
                BodyM += "<br />";
                BodyM += "<br /><span >Dettaglio Ordine</span><br />";
            ...
            string MailSubject = "[Ordine] # " + rapportini.CodRapportino + "  INSERITO - Cli: " + rapportini.Società;
