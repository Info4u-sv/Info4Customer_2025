...
namespace INTRA.Age_Ordini.AppCode
{
    ...
    public class TCK_EmailGest
    {
        ...
        public static void SendTicketMail(int TicketId, int TicketStatus, string UserCrud, TCK_Ticket rapportini, string MailTecnico, string NomeTecnico)
        {
        ...
        public TCK_EmailGest MailTemplateCreate(int TicketId, int TicketStatus, string UserCrud, TCK_Ticket rapportini, string MailTecnico, string NomeTecnico)
        {
            ...
            Ordini_Crud MyOrder = new Ordini_Crud();
            List<Ordini_Crud> MyOrderItems = new List<Ordini_Crud>();
            ...
            BodyM += string.Format(DivT, 15, "", "blue", "<b>Note: </b>" + rapportini.Note);
            if (!string.IsNullOrEmpty(rapportini.TckInviatoA))
            {
