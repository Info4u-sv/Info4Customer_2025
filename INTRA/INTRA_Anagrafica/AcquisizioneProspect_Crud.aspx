<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AcquisizioneProspect_Crud.aspx.cs" Inherits="INTRA.INTRA_Anagrafica.AcquisizioneProspect_Crud" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Acquisizione Prospect</h4>

                    <dx:ASPxGridView ID="Generic_gridview" Styles-AlternatingRow-Enabled="True" ClientInstanceName="Generic_gridview" DataSourceID="Generic_Dts" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="id" >
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Descrizione" VisibleIndex="1" EditFormCaptionStyle-CssClass="TitleCell" EditFormSettings-CaptionLocation="top">
                                <PropertiesTextEdit>
                                    <ValidationSettings>
                            ...
                            <dx:GridViewDataSpinEditColumn FieldName="DisplayOrder" VisibleIndex="2" EditFormCaptionStyle-CssClass="TitleCell" EditFormSettings-CaptionLocation="top">
    ...
    <asp:SqlDataSource ID="Generic_Dts" runat="server" ConnectionString='<%$ ConnectionStrings:info4portaleConnectionString %>' InsertCommand="INSERT INTO [CRM4U_CanaliAcquisizione](Descrizione, DisplayOrder) VALUES (@Descrizione, @DisplayOrder)" SelectCommand="SELECT [CRM4U_CanaliAcquisizione].* FROM [CRM4U_CanaliAcquisizione]" UpdateCommand="UPDATE [CRM4U_CanaliAcquisizione] SET Descrizione = @Descrizione, DisplayOrder = @DisplayOrder  WHERE (id = @id)">
        <InsertParameters>
