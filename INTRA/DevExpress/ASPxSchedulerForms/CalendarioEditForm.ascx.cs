...
public partial class CalendarioEditForm : SchedulerFormControl
{
    ...
    protected void TipoAttivita_Combo_DataBound(object sender, EventArgs e)
    { }
    protected void Status_Combobox_DataBound(object sender, EventArgs e)
    { }
    }
