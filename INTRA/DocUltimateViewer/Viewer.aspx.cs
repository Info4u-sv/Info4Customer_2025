...
namespace INTRA4U.DocUltimateViewer
{
    public partial class Viewer : System.Web.UI.Page
    {
        ...
        protected void RitornaAllaLista_Btn_Click(object sender, EventArgs e)
        {
            if (Session["PaginaDiRitornoSession"] != null)
            {
                Response.Redirect(Session["PaginaDiRitornoSession"].ToString());
            }
            else
            {
