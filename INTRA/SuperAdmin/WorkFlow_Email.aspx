...
<asp:Content ID="Content1" ContentPlaceHolderID="RootHolder" runat="server">
    <script>
        ...
        function OnGetRowValuesElimina(index) {
            ConfermaOperazioneWithClientFunction("Conferma Cancellazione", "Confermi di voler eliminare la riga?", "Conferma", "Annulla", Elimina, index);
        }
        function Elimina(Valore) {
            console.log('Valore => ' + Valore);
            Generic_Gridview.DeleteRow(Number(Valore));
        }
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <dx:ASPxGridView runat="server" ID="Generic_Gridview" ClientInstanceName="Generic_Gridview" AutoGenerateColumns="False" DataSourceID="Generic_Dts" KeyFieldName="ID" Styles-AlternatingRow-Enabled="True" SettingsPopup-EditForm-HorizontalAlign="WindowCenter" SettingsPopup-EditForm-VerticalAlign="WindowCenter" Width="100%" OnRowInserting="Generic_Gridview_RowInserting" OnRowUpdating="Generic_Gridview_RowUpdating">
                        ...
                        <Columns>
                            <dx:GridViewCommandColumn ShowNewButtonInHeader="True" VisibleIndex="0" ShowEditButton="True" ShowClearFilterButton="true" Width="60px">
                                <CustomButtons>
                            ...
                            <dx:GridViewDataTextColumn FieldName="ID" ReadOnly="True" VisibleIndex="1" Visible="true" Width="60px">
                        ...
                        <Templates>
                            <EditForm>
                                ...
                                <div class="col-lg-12">
                                    Email:
                                    <dx:ASPxTokenBox runat="server" ID="Email_Token" ClientInstanceName="Email_Token" DataSourceID="Email_List_Dts" ValueField="ID" TextField="Email" Width="100%" Text='<%#Bind("Email") %>'></dx:ASPxTokenBox>
                                </div>

                                <div class="col-lg-12">
                                    Descrizione:
                                    <dx:ASPxTextBox runat="server" ID="Descrizione_Txt" ClientInstanceName="Descrizione_Txt" Width="100%" Text='<%#Bind("Descrizione") %>'></dx:ASPxTextBox>
                                </div>
                                <div class="col-lg-12">
                                    Modificabile dal cliente:
                                    <dx:ASPxCheckBox runat="server" ID="IsFrontEnd_Check" ClientInstanceName="IsFrontEnd_Check" Checked='<%# Bind("IsFrontEnd") %>'></dx:ASPxCheckBox>
                                </div>
