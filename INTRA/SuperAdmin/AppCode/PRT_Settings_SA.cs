...
public class PRT_setting_Manage_SA
{
    public PRT_setting_Manage_SA()
    {
        //
    ...
    public int InsertPRT_Setting(PRT_setting_Manage_SA setting)
    {
    ...
    public void UpdatePRT_Setting(PRT_setting_Manage_SA setting)
    {
