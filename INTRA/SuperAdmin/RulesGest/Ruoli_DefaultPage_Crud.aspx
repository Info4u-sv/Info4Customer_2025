        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Ruoli abilita Pagina di Default
                    </h4>
                    <div class="col-lg-12" style="color: red">
                        Questa pagina di default per il ruolo viene sostituita dalla pagina di default impostata sul singolo utente.
                        <br />
                        La pagina viene salvata per ogni utente in un cookie, quindi per testare la modifica devi cancellare i Cookie
                    </div>
                    <dx:ASPxGridView runat="server" ID="Generic_Gridview" ClientInstanceName="Generic_Gridview" AutoGenerateColumns="False" DataSourceID="Generic_Sql" KeyFieldName="RoleId" Width="100%" Styles-AlternatingRow-Enabled="True" SettingsPopup-EditForm-HorizontalAlign="WindowCenter" SettingsPopup-EditForm-VerticalAlign="WindowCenter">
                        ...
                        <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="DataAware" Landscape="true" LeftMargin="30" FileName="Lista_Ruoli_Abilita_Pagina_Di_Default" />
